...
$todos = @(
    ...
    @{ local = "tareas.html";                remoto = "tareas.html" },
    ...
    @{ local = "assets\calendar.png";        remoto = "assets/calendar.png" },
    ...
    @{ local = "assets\frescura.js";         remoto = "assets/frescura.js" },
    ...
    @{ local = "scripts\subir-ftp.ps1";          remoto = "scripts/subir-ftp.ps1" },

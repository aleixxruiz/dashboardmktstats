...
(function(){
  ...
  var css = ''
   ...
   + '.asis-head{display:flex;justify-content:space-between;align-items:center;padding:14px 16px;background:#13294b;font-weight:700}'
   + '.asis-head .x{cursor:pointer;color:#9fb6d6;font-size:18px}'
   + '.asis-body{padding:16px}'
   + '.asis-op{display:flex;align-items:center;gap:12px;width:100%;text-align:left;background:#16304f;border:1px solid #294a6e;'
   + 'color:#eaf1fb;border-radius:12px;padding:14px;margin-bottom:10px;cursor:pointer;font-size:14px;transition:.15s}'
   + '.asis-op:hover{border-color:#34a0d9;background:#1a3a5e}'
   + '.asis-op .ic{font-size:24px}'
   + '.asis-op b{display:block;font-size:14.5px}.asis-op span{font-size:12px;color:#9fb6d6}'
   ...
   + '.asis-m.u{align-self:flex-end;background:#1f5f9b;color:#fff}'
   + '.asis-m.a{align-self:flex-start;background:#16304f;border:1px solid #294a6e}'
   + '.asis-in{display:flex;gap:8px;padding:12px;border-top:1px solid #294a6e}'
   + '.asis-in input{flex:1;background:#0a1830;border:1px solid #294a6e;color:#eaf1fb;border-radius:10px;padding:10px;font-size:13.5px;outline:none}'
   + '.asis-in button{background:#34a0d9;border:none;color:#fff;border-radius:10px;padding:0 14px;cursor:pointer;font-weight:700}'
   + '.asis-back{padding:8px 16px;color:#9fb6d6;cursor:pointer;font-size:12.5px;border-bottom:1px solid #294a6e}'
   + '.asis-back:hover{color:#fff}';
